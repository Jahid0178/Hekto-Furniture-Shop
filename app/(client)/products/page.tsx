...
import ProductSidebar from "@/components/client/Products/ProductSidebar/ProductSidebar";
    ...
    <>
      ...
      <section>
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[300px_minmax(900px,_1fr)] gap-4">
            <ProductSidebar />
